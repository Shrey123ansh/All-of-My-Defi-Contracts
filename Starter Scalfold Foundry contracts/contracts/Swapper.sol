...
contract Swapper is ISwapper, Ownable {
    ...
    function swap(
        ...
        require(address(pair) != address(0), "BrewFairX: Cannot convert");
        ...
        require(
            ui1.div(amountIn) > slippage || slippageOverrode[fromToken],
            "slippage too high"
        );

        require(amountIn > 0, "BrewFairX: INSUFFICIENT_INPUT_AMOUNT");
        require(ui1 > 0 && ui2 > 0, "BrewFairX: INSUFFICIENT_LIQUIDITY");
